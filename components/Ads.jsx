  ...
  return (
    <>
      <motion.div
        ...
        className="relative break-inside-avoid h-[300px] w-full flex flex-col items-center justify-center hover:scale-[0.98] transition-all rounded-2xl overflow-hidden"
      >
